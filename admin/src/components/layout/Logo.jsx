...
/**
 * The Airbnb bélo mark plus the "airbnb" wordmark, linking to the listings
 * page. Matches the Figma export exactly: just the mark + wordmark, no
 * "Host dashboard" subtitle, in the export's measured red (#DE3151).
 */
