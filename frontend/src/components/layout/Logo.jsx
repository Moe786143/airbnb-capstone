...
/**
 * The Airbnb wordmark in the header — the "bélo" symbol plus the name,
 * linking back to the home page. The word is hidden on narrow screens so
 * the search pill keeps its room.
 */
